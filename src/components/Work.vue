<template>
  <div class=" flex flex-row sx:flex-col h-screen sx:w-11/12   w-10/12 m-auto justify-center items-center mt-36">
    ...
    <div class=" text-5xl font-bold tracking-wide w-2/3 sx:text-3xl text-header">In the last few years;</div>
      <div class=" text-white text-sm mt-4  leading-7 sx:leading-6 tracking-wide sx:tracking-normal sx:font-normal line">I have been oppurtuned to put my skill to practice by building for different companies and organizations as a Frontend engineer with indebt ability to transform literal designs into functional UI's and scalable applications optimized for best performance.
         <br class=" mb-6"/>
    ...
    <div class="sx:w-3/4 sx:mt-10 sx:justify-center sx:items-center w-1/2 m-auto flex justify-center items-start">
